//////////////////////////////////////////////////////////////////////////////
// Reads command input from a file (via redirection) and tests methods
// based on the command, input, and expected result
//////////////////////////////////////////////////////////////////////////////
...
public class driver {
  ...
  // Redundant as fc_result and prep rely on toString working.
	...
	} else if ( values.length == 2 ) { // fraction
	    try {
	...
	try {
	    for ( int i = 0; i < 3; i++ ) ARGS[ i ] = Integer.parseInt( parts[ 2 + i ] );
	} catch ( Exception e ) {
	    log( false, "Invalid argument syntax" );
	    return;
	}
